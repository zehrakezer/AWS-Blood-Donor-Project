...
const LeadModal = ({ active, handleModal, token, id, setErrorMessage }) => {
  ...
  useEffect(() => {
    const getLead = async () => {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/leads/${id}`, requestOptions);
  ...
  const handleCreateLead = async (e) => {
    ...
    const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/leads`, requestOptions);
    if (!response.ok) {
